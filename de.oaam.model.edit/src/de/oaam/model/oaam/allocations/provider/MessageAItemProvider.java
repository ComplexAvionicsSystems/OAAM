...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.allocations.MessageA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageAItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MessageAItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MessageA"));
	}
	...
	public String getText(Object object) {
		String label = ((MessageA)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MessageA_type") :
			getString("_UI_MessageA_type") + " " + label;
	}
