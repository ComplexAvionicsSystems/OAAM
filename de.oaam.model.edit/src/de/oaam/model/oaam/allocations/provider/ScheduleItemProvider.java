...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.allocations.Schedule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduleItemProvider extends OaamBaseElementAItemProvider {
	/**
	...
	protected void addRatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_rate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_rate_feature", "_UI_Schedule_type"),
				 AllocationsPackage.Literals.SCHEDULE__RATE,
				 true,
				 false,
				 false,
	...
	protected void addIsPeriodicPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_isPeriodic_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_isPeriodic_feature", "_UI_Schedule_type"),
				 AllocationsPackage.Literals.SCHEDULE__IS_PERIODIC,
				 true,
				 false,
				 false,
	...
	protected void addPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_priority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_priority_feature", "_UI_Schedule_type"),
				 AllocationsPackage.Literals.SCHEDULE__PRIORITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AllocationsPackage.Literals.SCHEDULE__SCHEDULED_TIMES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AllocationsPackage.Literals.SCHEDULE__SCHEDULED_TIMES,
