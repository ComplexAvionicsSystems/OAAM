...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.allocations.SignalAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalAssignmentItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalAssignmentItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSignalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalAssignment_signal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalAssignment_signal_feature", "_UI_SignalAssignment_type"),
				 AllocationsPackage.Literals.SIGNAL_ASSIGNMENT__SIGNAL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AllocationsPackage.Literals.SIGNAL_ASSIGNMENT__SEGMENTS);
		}
	...
	/**
	 * This returns SignalAssignment.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalAssignment"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalAssignment)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalAssignment.class)) {
