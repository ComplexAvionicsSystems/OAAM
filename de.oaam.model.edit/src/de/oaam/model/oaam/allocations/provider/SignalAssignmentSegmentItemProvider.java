...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.allocations.SignalAssignmentSegment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalAssignmentSegmentItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalAssignmentSegmentItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalAssignmentSegment_capability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalAssignmentSegment_capability_feature", "_UI_SignalAssignmentSegment_type"),
				 AllocationsPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDevicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalAssignmentSegment_device_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalAssignmentSegment_device_feature", "_UI_SignalAssignmentSegment_type"),
				 AllocationsPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT__DEVICE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConnectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalAssignmentSegment_connection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalAssignmentSegment_connection_feature", "_UI_SignalAssignmentSegment_type"),
				 AllocationsPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT__CONNECTION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SignalAssignmentSegment.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalAssignmentSegment"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalAssignmentSegment)object).getName();
