...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.allocations.TaskAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskAssignmentItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskAssignmentItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskAssignment_capability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskAssignment_capability_feature", "_UI_TaskAssignment_type"),
				 AllocationsPackage.Literals.TASK_ASSIGNMENT__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTaskPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskAssignment_task_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskAssignment_task_feature", "_UI_TaskAssignment_type"),
				 AllocationsPackage.Literals.TASK_ASSIGNMENT__TASK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDevicePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskAssignment_device_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskAssignment_device_feature", "_UI_TaskAssignment_type"),
				 AllocationsPackage.Literals.TASK_ASSIGNMENT__DEVICE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns TaskAssignment.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskAssignment"));
	}
	...
	public String getText(Object object) {
		String label = ((TaskAssignment)object).getName();
