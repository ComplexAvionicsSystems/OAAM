...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.anatomy.AreaSymmetry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AreaSymmetryItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AreaSymmetryItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAreasPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AreaSymmetry_areas_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AreaSymmetry_areas_feature", "_UI_AreaSymmetry_type"),
				 AnatomyPackage.Literals.AREA_SYMMETRY__AREAS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AreaSymmetry"));
	}
	...
	public String getText(Object object) {
		String label = ((AreaSymmetry)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AreaSymmetry.class)) {
