	...
	protected void addStartingPointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duct_startingPoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duct_startingPoint_feature", "_UI_Duct_type"),
				 AnatomyPackage.Literals.DUCT__STARTING_POINT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEndPointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duct_endPoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duct_endPoint_feature", "_UI_Duct_type"),
				 AnatomyPackage.Literals.DUCT__END_POINT,
				 true,
				 false,
				 true,
				 null,
