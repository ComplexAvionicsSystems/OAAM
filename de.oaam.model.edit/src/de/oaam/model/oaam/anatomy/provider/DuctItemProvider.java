...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.anatomy.Duct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DuctItemProvider extends ResourceProviderInstanceAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DuctItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDuctopeningAPropertyDescriptor(object);
			addDuctopeningBPropertyDescriptor(object);
		}
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duct_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duct_length_feature", "_UI_Duct_type"),
				 AnatomyPackage.Literals.DUCT__LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duct_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duct_type_feature", "_UI_Duct_type"),
				 AnatomyPackage.Literals.DUCT__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Ductopening A feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDuctopeningAPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duct_ductopeningA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duct_ductopeningA_feature", "_UI_Duct_type"),
				 AnatomyPackage.Literals.DUCT__DUCTOPENING_A,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Ductopening B feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDuctopeningBPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Duct_ductopeningB_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Duct_ductopeningB_feature", "_UI_Duct_type"),
				 AnatomyPackage.Literals.DUCT__DUCTOPENING_B,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Duct"));
	}
	...
	public String getText(Object object) {
		String label = ((Duct)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Duct.class)) {
