...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.anatomy.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends ResourceProviderInstanceAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_type_feature", "_UI_Location_type"),
				 AnatomyPackage.Literals.LOCATION__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_length_feature", "_UI_Location_type"),
				 AnatomyPackage.Literals.LOCATION__LENGTH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnatomyPackage.Literals.LOCATION__POSITION);
			childrenFeatures.add(AnatomyPackage.Literals.LOCATION__DUCT_OPENINGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnatomyPackage.Literals.LOCATION__POSITION,
				 AnatomyFactory.eINSTANCE.createPosition3D()));

		newChildDescriptors.add
			(createChildParameter
				(AnatomyPackage.Literals.LOCATION__DUCT_OPENINGS,
