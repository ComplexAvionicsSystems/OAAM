...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.ConnectionCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConnectionCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addConnectionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionCapability_connectionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionCapability_connectionType_feature", "_UI_ConnectionCapability_type"),
				 CapabilitiesPackage.Literals.CONNECTION_CAPABILITY__CONNECTION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLocationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionCapability_locationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionCapability_locationType_feature", "_UI_ConnectionCapability_type"),
				 CapabilitiesPackage.Literals.CONNECTION_CAPABILITY__LOCATION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDuctTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionCapability_ductType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionCapability_ductType_feature", "_UI_ConnectionCapability_type"),
				 CapabilitiesPackage.Literals.CONNECTION_CAPABILITY__DUCT_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ConnectionCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConnectionCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((ConnectionCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConnectionCapability_type") :
			getString("_UI_ConnectionCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConnectionCapability.class)) {
