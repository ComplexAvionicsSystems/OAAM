...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.DeviceCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DeviceCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceCapability_deviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceCapability_deviceType_feature", "_UI_DeviceCapability_type"),
				 CapabilitiesPackage.Literals.DEVICE_CAPABILITY__DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLocationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceCapability_locationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceCapability_locationType_feature", "_UI_DeviceCapability_type"),
				 CapabilitiesPackage.Literals.DEVICE_CAPABILITY__LOCATION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns DeviceCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeviceCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((DeviceCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DeviceCapability_type") :
			getString("_UI_DeviceCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeviceCapability.class)) {
