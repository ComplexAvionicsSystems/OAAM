...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.DeviceInLocationCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceInLocationCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DeviceInLocationCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceInLocationCapability_deviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceInLocationCapability_deviceType_feature", "_UI_DeviceInLocationCapability_type"),
				 CapabilitiesPackage.Literals.DEVICE_IN_LOCATION_CAPABILITY__DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLocationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceInLocationCapability_locationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceInLocationCapability_locationType_feature", "_UI_DeviceInLocationCapability_type"),
				 CapabilitiesPackage.Literals.DEVICE_IN_LOCATION_CAPABILITY__LOCATION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns DeviceInLocationCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeviceInLocationCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((DeviceInLocationCapability)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeviceInLocationCapability.class)) {
