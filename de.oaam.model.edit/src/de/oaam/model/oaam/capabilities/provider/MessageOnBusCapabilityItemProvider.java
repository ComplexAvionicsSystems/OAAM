...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.MessageOnBusCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageOnBusCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MessageOnBusCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addBusTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageOnBusCapability_busType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageOnBusCapability_busType_feature", "_UI_MessageOnBusCapability_type"),
				 CapabilitiesPackage.Literals.MESSAGE_ON_BUS_CAPABILITY__BUS_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMessageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageOnBusCapability_messageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageOnBusCapability_messageType_feature", "_UI_MessageOnBusCapability_type"),
				 CapabilitiesPackage.Literals.MESSAGE_ON_BUS_CAPABILITY__MESSAGE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns MessageOnBusCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MessageOnBusCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((MessageOnBusCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MessageOnBusCapability_type") :
			getString("_UI_MessageOnBusCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MessageOnBusCapability.class)) {
