...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.MessageOnConnectionOrDeviceCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageOnConnectionOrDeviceCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MessageOnConnectionOrDeviceCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addMessageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageOnConnectionOrDeviceCapability_messageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageOnConnectionOrDeviceCapability_messageType_feature", "_UI_MessageOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.MESSAGE_ON_CONNECTION_OR_DEVICE_CAPABILITY__MESSAGE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageOnConnectionOrDeviceCapability_deviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageOnConnectionOrDeviceCapability_deviceType_feature", "_UI_MessageOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.MESSAGE_ON_CONNECTION_OR_DEVICE_CAPABILITY__DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConnectionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageOnConnectionOrDeviceCapability_connectionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageOnConnectionOrDeviceCapability_connectionType_feature", "_UI_MessageOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.MESSAGE_ON_CONNECTION_OR_DEVICE_CAPABILITY__CONNECTION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addWorstCaseTransmissionTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MessageOnConnectionOrDeviceCapability_worstCaseTransmissionTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MessageOnConnectionOrDeviceCapability_worstCaseTransmissionTime_feature", "_UI_MessageOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.MESSAGE_ON_CONNECTION_OR_DEVICE_CAPABILITY__WORST_CASE_TRANSMISSION_TIME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns MessageOnConnectionOrDeviceCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MessageOnConnectionOrDeviceCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((MessageOnConnectionOrDeviceCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MessageOnConnectionOrDeviceCapability_type") :
			getString("_UI_MessageOnConnectionOrDeviceCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MessageOnConnectionOrDeviceCapability.class)) {
