...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.SignalCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSignalTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalCapability_signalType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalCapability_signalType_feature", "_UI_SignalCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_CAPABILITY__SIGNAL_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalCapability_deviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalCapability_deviceType_feature", "_UI_SignalCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_CAPABILITY__DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConnectionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalCapability_connectionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalCapability_connectionType_feature", "_UI_SignalCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_CAPABILITY__CONNECTION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SignalCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SignalCapability_type") :
			getString("_UI_SignalCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalCapability.class)) {
