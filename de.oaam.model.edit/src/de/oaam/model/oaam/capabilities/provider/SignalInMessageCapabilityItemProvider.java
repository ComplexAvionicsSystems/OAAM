...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.SignalInMessageCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalInMessageCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalInMessageCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addMessageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalInMessageCapability_messageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalInMessageCapability_messageType_feature", "_UI_SignalInMessageCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_IN_MESSAGE_CAPABILITY__MESSAGE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSignalTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalInMessageCapability_signalType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalInMessageCapability_signalType_feature", "_UI_SignalInMessageCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_IN_MESSAGE_CAPABILITY__SIGNAL_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SignalInMessageCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalInMessageCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalInMessageCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SignalInMessageCapability_type") :
			getString("_UI_SignalInMessageCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalInMessageCapability.class)) {
