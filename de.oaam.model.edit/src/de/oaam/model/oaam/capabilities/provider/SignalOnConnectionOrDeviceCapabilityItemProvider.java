...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.SignalOnConnectionOrDeviceCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalOnConnectionOrDeviceCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalOnConnectionOrDeviceCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSignalTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalOnConnectionOrDeviceCapability_signalType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalOnConnectionOrDeviceCapability_signalType_feature", "_UI_SignalOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_ON_CONNECTION_OR_DEVICE_CAPABILITY__SIGNAL_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalOnConnectionOrDeviceCapability_deviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalOnConnectionOrDeviceCapability_deviceType_feature", "_UI_SignalOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_ON_CONNECTION_OR_DEVICE_CAPABILITY__DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConnectionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalOnConnectionOrDeviceCapability_connectionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalOnConnectionOrDeviceCapability_connectionType_feature", "_UI_SignalOnConnectionOrDeviceCapability_type"),
				 CapabilitiesPackage.Literals.SIGNAL_ON_CONNECTION_OR_DEVICE_CAPABILITY__CONNECTION_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SignalOnConnectionOrDeviceCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalOnConnectionOrDeviceCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalOnConnectionOrDeviceCapability)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalOnConnectionOrDeviceCapability.class)) {
