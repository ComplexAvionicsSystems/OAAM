...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.Subcapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubcapabilityItemProvider extends CapabilitiesContainerAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SubcapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Subcapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Subcapability"));
	}
	...
	public String getText(Object object) {
		String label = ((Subcapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Subcapability_type") :
			getString("_UI_Subcapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Subcapability.class)) {
