...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.SubdeviceInDeviceCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubdeviceInDeviceCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SubdeviceInDeviceCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Subdevice Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSubdeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubdeviceInDeviceCapability_subdeviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubdeviceInDeviceCapability_subdeviceType_feature", "_UI_SubdeviceInDeviceCapability_type"),
				 CapabilitiesPackage.Literals.SUBDEVICE_IN_DEVICE_CAPABILITY__SUBDEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubdeviceInDeviceCapability_targetDeviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubdeviceInDeviceCapability_targetDeviceType_feature", "_UI_SubdeviceInDeviceCapability_type"),
				 CapabilitiesPackage.Literals.SUBDEVICE_IN_DEVICE_CAPABILITY__TARGET_DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SubdeviceInDeviceCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SubdeviceInDeviceCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((SubdeviceInDeviceCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SubdeviceInDeviceCapability_type") :
			getString("_UI_SubdeviceInDeviceCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubdeviceInDeviceCapability.class)) {
