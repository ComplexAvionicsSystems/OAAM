...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.SubmessageInMessageCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubmessageInMessageCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SubmessageInMessageCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSubmessageTypePropertyDescriptor(object);
		}
	...
	protected void addMessageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubmessageInMessageCapability_messageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubmessageInMessageCapability_messageType_feature", "_UI_SubmessageInMessageCapability_type"),
				 CapabilitiesPackage.Literals.SUBMESSAGE_IN_MESSAGE_CAPABILITY__MESSAGE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Submessage Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSubmessageTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubmessageInMessageCapability_submessageType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubmessageInMessageCapability_submessageType_feature", "_UI_SubmessageInMessageCapability_type"),
				 CapabilitiesPackage.Literals.SUBMESSAGE_IN_MESSAGE_CAPABILITY__SUBMESSAGE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SubmessageInMessageCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SubmessageInMessageCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((SubmessageInMessageCapability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SubmessageInMessageCapability_type") :
			getString("_UI_SubmessageInMessageCapability_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubmessageInMessageCapability.class)) {
