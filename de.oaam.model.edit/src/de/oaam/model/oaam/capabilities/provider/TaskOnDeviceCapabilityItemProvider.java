...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.capabilities.TaskOnDeviceCapability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskOnDeviceCapabilityItemProvider extends CapabilityAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskOnDeviceCapabilityItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTaskTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskOnDeviceCapability_taskType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskOnDeviceCapability_taskType_feature", "_UI_TaskOnDeviceCapability_type"),
				 CapabilitiesPackage.Literals.TASK_ON_DEVICE_CAPABILITY__TASK_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDeviceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskOnDeviceCapability_deviceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskOnDeviceCapability_deviceType_feature", "_UI_TaskOnDeviceCapability_type"),
				 CapabilitiesPackage.Literals.TASK_ON_DEVICE_CAPABILITY__DEVICE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addWorstCaseExecutionTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskOnDeviceCapability_worstCaseExecutionTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskOnDeviceCapability_worstCaseExecutionTime_feature", "_UI_TaskOnDeviceCapability_type"),
				 CapabilitiesPackage.Literals.TASK_ON_DEVICE_CAPABILITY__WORST_CASE_EXECUTION_TIME,
				 true,
				 false,
				 false,
	...
	protected void addFailureProbabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskOnDeviceCapability_failureProbability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskOnDeviceCapability_failureProbability_feature", "_UI_TaskOnDeviceCapability_type"),
				 CapabilitiesPackage.Literals.TASK_ON_DEVICE_CAPABILITY__FAILURE_PROBABILITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	/**
	 * This returns TaskOnDeviceCapability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskOnDeviceCapability"));
	}
	...
	public String getText(Object object) {
		String label = ((TaskOnDeviceCapability)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TaskOnDeviceCapability.class)) {
