...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.common.Struct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructItemProvider extends DataTypeAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Struct_alignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Struct_alignment_feature", "_UI_Struct_type"),
				 CommonPackage.Literals.STRUCT__ALIGNMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonPackage.Literals.STRUCT__FIELDS,
				 true,
				 false,
				 true,
				 null,
