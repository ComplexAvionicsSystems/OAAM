...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.common._ElementA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class _ElementAItemProvider 
	 ...
	 * @generated
	 */
	public _ElementAItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((_ElementA)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI__ElementA_type") :
			getString("_UI__ElementA_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(_ElementA.class)) {
