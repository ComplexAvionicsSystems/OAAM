...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.functions.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends OaamBaseElementAItemProvider {
	/**
	...
	protected void addDeclarationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_declaration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_declaration_feature", "_UI_Input_type"),
				 FunctionsPackage.Literals.INPUT__DECLARATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addImplementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_implements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_implements_feature", "_UI_Input_type"),
				 FunctionsPackage.Literals.INPUT__IMPLEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIoBindingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_ioBindings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_ioBindings_feature", "_UI_Input_type"),
				 FunctionsPackage.Literals.INPUT__IO_BINDINGS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addQueueLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_queueLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_queueLength_feature", "_UI_Input_type"),
				 FunctionsPackage.Literals.INPUT__QUEUE_LENGTH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.INPUT__OUTPUT_LINK);
		}
