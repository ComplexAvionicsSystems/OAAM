...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.functions.OutputLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputLinkItemProvider extends _ElementAItemProvider {
	/**
	...
	protected void addOutputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputLink_output_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputLink_output_feature", "_UI_OutputLink_type"),
				 FunctionsPackage.Literals.OUTPUT_LINK__OUTPUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputLink_filter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputLink_filter_feature", "_UI_OutputLink_type"),
				 FunctionsPackage.Literals.OUTPUT_LINK__FILTER,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OutputLink"));
	}
	...
	public String getText(Object object) {
		String label = ((OutputLink)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OutputLink_type") :
			getString("_UI_OutputLink_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OutputLink.class)) {
