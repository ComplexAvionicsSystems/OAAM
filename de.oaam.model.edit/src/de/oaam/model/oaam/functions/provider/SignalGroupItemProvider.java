...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.functions.SignalGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalGroupItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalGroupItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSignalsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalGroup_signals_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalGroup_signals_feature", "_UI_SignalGroup_type"),
				 FunctionsPackage.Literals.SIGNAL_GROUP__SIGNALS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SignalGroup_type") :
			getString("_UI_SignalGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalGroup.class)) {
