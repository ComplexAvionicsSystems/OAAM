...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.functions.TaskFailure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskFailureItemProvider extends BoolAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskFailureItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTaskStatePropertyDescriptor(object);
			addTaskFailureModePropertyDescriptor(object);
			addFailsWithPropertyDescriptor(object);
		}
	...
	protected void addTaskPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskFailure_task_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskFailure_task_feature", "_UI_TaskFailure_type"),
				 FunctionsPackage.Literals.TASK_FAILURE__TASK,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Task State feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaskStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskFailure_taskState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskFailure_taskState_feature", "_UI_TaskFailure_type"),
				 FunctionsPackage.Literals.TASK_FAILURE__TASK_STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Task Failure Mode feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaskFailureModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskFailure_taskFailureMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskFailure_taskFailureMode_feature", "_UI_TaskFailure_type"),
				 FunctionsPackage.Literals.TASK_FAILURE__TASK_FAILURE_MODE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Fails With feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFailsWithPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskFailure_failsWith_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskFailure_failsWith_feature", "_UI_TaskFailure_type"),
				 FunctionsPackage.Literals.TASK_FAILURE__FAILS_WITH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskFailure"));
	}
	...
	public String getText(Object object) {
		String label = ((TaskFailure)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TaskFailure_type") :
			getString("_UI_TaskFailure_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TaskFailure.class)) {
