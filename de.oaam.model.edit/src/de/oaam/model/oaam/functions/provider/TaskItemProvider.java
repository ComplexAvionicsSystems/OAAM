...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.functions.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends OaamBaseElementAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FunctionsPackage.Literals.TASK__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addImplementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_implements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_implements_feature", "_UI_Task_type"),
				 FunctionsPackage.Literals.TASK__IMPLEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Device Binding feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDeviceBindingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_deviceBinding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_deviceBinding_feature", "_UI_Task_type"),
				 FunctionsPackage.Literals.TASK__DEVICE_BINDING,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the NParallels feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNParallelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_nParallels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_nParallels_feature", "_UI_Task_type"),
				 FunctionsPackage.Literals.TASK__NPARALLELS,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.TASK__INPUTS,
