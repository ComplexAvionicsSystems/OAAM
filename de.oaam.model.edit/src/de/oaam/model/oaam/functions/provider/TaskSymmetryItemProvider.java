...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.functions.TaskSymmetry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskSymmetryItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskSymmetryItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskSymmetry_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskSymmetry_tasks_feature", "_UI_TaskSymmetry_type"),
				 FunctionsPackage.Literals.TASK_SYMMETRY__TASKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskSymmetry"));
	}
	...
	public String getText(Object object) {
		String label = ((TaskSymmetry)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TaskSymmetry.class)) {
