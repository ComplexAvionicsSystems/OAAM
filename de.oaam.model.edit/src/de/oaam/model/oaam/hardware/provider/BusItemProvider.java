...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.hardware.Bus} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BusItemProvider extends ResourceProviderInstanceAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HardwarePackage.Literals.BUS__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConnectionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bus_connections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bus_connections_feature", "_UI_Bus_type"),
				 HardwarePackage.Literals.BUS__CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDevicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bus_devices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bus_devices_feature", "_UI_Bus_type"),
				 HardwarePackage.Literals.BUS__DEVICES,
				 true,
				 false,
				 true,
				 null,
