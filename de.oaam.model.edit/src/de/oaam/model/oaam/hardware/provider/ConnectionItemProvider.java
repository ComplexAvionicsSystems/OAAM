...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.hardware.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider extends ResourceProviderInstanceAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HardwarePackage.Literals.CONNECTION__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEndPointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_endPoints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_endPoints_feature", "_UI_Connection_type"),
				 HardwarePackage.Literals.CONNECTION__END_POINTS,
				 true,
				 false,
				 true,
				 null,
