...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.hardware.Io} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IoItemProvider extends OaamBaseElementAItemProvider {
	/**
	...
	protected void addDeclarationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Io_declaration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Io_declaration_feature", "_UI_Io_type"),
				 HardwarePackage.Literals.IO__DECLARATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Io"));
	}
	...
	public String getText(Object object) {
		String label = ((Io)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Io.class)) {
