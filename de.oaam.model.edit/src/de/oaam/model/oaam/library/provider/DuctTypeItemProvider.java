...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.library.DuctType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DuctTypeItemProvider extends ResourceProviderAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DuctTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DuctType"));
	}
	...
	public String getText(Object object) {
		String label = ((DuctType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DuctType_type") :
			getString("_UI_DuctType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DuctType.class)) {
