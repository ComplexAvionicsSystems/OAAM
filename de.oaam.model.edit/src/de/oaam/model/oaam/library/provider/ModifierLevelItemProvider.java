...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.library.ModifierLevel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModifierLevelItemProvider extends _ElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ModifierLevelItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModifierLevel_equalAlternatives_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModifierLevel_equalAlternatives_feature", "_UI_ModifierLevel_type"),
				 LibraryPackage.Literals.MODIFIER_LEVEL__EQUAL_ALTERNATIVES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBetterAlternativePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModifierLevel_betterAlternative_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModifierLevel_betterAlternative_feature", "_UI_ModifierLevel_type"),
				 LibraryPackage.Literals.MODIFIER_LEVEL__BETTER_ALTERNATIVE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ModifierLevel.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ModifierLevel"));
	}
	...
	public String getText(Object object) {
		String label = ((ModifierLevel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModifierLevel_type") :
			getString("_UI_ModifierLevel_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModifierLevel.class)) {
