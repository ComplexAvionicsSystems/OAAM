...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.library.ResourceBundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceBundleItemProvider extends ResourceConsumerAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ResourceBundleItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addMtbfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceBundle_mtbf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceBundle_mtbf_feature", "_UI_ResourceBundle_type"),
				 LibraryPackage.Literals.RESOURCE_BUNDLE__MTBF,
				 true,
				 false,
				 false,
	...
	protected void addCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceBundle_cost_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceBundle_cost_feature", "_UI_ResourceBundle_type"),
				 LibraryPackage.Literals.RESOURCE_BUNDLE__COST,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addMassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceBundle_mass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceBundle_mass_feature", "_UI_ResourceBundle_type"),
				 LibraryPackage.Literals.RESOURCE_BUNDLE__MASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LibraryPackage.Literals.RESOURCE_BUNDLE__RESOURCES);
		}
	...
	/**
	 * This returns ResourceBundle.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ResourceBundle"));
	}
	...
	public String getText(Object object) {
		String label = ((ResourceBundle)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ResourceBundle_type") :
			getString("_UI_ResourceBundle_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ResourceBundle.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.RESOURCE_BUNDLE__RESOURCES,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == LibraryPackage.Literals.RESOURCE_BUNDLE__RESOURCES;
