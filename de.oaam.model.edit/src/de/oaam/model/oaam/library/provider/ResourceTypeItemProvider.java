...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.library.ResourceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceTypeItemProvider extends ResourceConsumerAItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsIoPropertyDescriptor(object);
			addIsConfigurablePropertyDescriptor(object);
			addAllowedModifiersPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Is Consumed feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsConsumedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_isConsumed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_isConsumed_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__IS_CONSUMED,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Is Distinguishable feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsDistinguishablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_isDistinguishable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_isDistinguishable_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__IS_DISTINGUISHABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Is Propagated feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsPropagatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_isPropagated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_isPropagated_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__IS_PROPAGATED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addDirectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_direction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_direction_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__DIRECTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Is Io feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsIoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_isIo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_isIo_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__IS_IO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addIsConfigurablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_isConfigurable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_isConfigurable_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__IS_CONFIGURABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Allowed Modifiers feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAllowedModifiersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_allowedModifiers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_allowedModifiers_feature", "_UI_ResourceType_type"),
				 LibraryPackage.Literals.RESOURCE_TYPE__ALLOWED_MODIFIERS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.RESOURCE_TYPE__PROPAGETED_RESOURCES,
				 LibraryFactory.eINSTANCE.createResource()));

		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.RESOURCE_TYPE__ALTERNATIVES,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == LibraryPackage.Literals.RESOURCE_CONSUMER_A__REQUIRED_RESOURCES ||
			childFeature == LibraryPackage.Literals.RESOURCE_TYPE__PROPAGETED_RESOURCES;
