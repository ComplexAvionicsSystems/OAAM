...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.library.SignalType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalTypeItemProvider extends ResourceConsumerAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.SIGNAL_TYPE__TYPE,
				 true,
				 false,
				 true,
				 null,
