...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.mapping.DeviceAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceAssignmentItemProvider extends _ElementAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.DEVICE_ASSIGNMENT__DEVICE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.DEVICE_ASSIGNMENT__LOCATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.DEVICE_ASSIGNMENT__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
