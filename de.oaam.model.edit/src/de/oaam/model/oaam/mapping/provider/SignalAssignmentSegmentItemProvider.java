...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.mapping.SignalAssignmentSegment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalAssignmentSegmentItemProvider extends ElementAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT__DEVICE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT__CONNECTION,
				 true,
				 false,
				 true,
				 null,
