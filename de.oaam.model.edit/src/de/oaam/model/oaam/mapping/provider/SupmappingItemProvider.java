...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.mapping.Supmapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SupmappingItemProvider extends MappingContainerAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SupmappingItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Supmapping"));
	}
	...
	public String getText(Object object) {
		String label = ((Supmapping)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Supmapping_type") :
			getString("_UI_Supmapping_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Supmapping.class)) {
