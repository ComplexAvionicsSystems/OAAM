...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.mapping.TaskAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskAssignmentItemProvider extends _ElementAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TASK_ASSIGNMENT__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TASK_ASSIGNMENT__TASK,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MappingPackage.Literals.TASK_ASSIGNMENT__DEVICE,
				 true,
				 false,
				 true,
				 null,
