...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.restrictions.DeviceRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceRestrictionItemProvider extends TaskRestrictionAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DeviceRestrictionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDeviceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceRestriction_deviceName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceRestriction_deviceName_feature", "_UI_DeviceRestriction_type"),
				 RestrictionsPackage.Literals.DEVICE_RESTRICTION__DEVICE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsForbiddenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceRestriction_isForbidden_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceRestriction_isForbidden_feature", "_UI_DeviceRestriction_type"),
				 RestrictionsPackage.Literals.DEVICE_RESTRICTION__IS_FORBIDDEN,
				 true,
				 false,
				 false,
	...
	protected void addDevicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeviceRestriction_devices_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceRestriction_devices_feature", "_UI_DeviceRestriction_type"),
				 RestrictionsPackage.Literals.DEVICE_RESTRICTION__DEVICES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns DeviceRestriction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeviceRestriction"));
	}
	...
	public String getText(Object object) {
		String label = ((DeviceRestriction)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeviceRestriction.class)) {
