...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.restrictions.PathDelayRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathDelayRestrictionItemProvider extends PathRestrictionAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PathDelayRestrictionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDelayPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathDelayRestriction_delay_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathDelayRestriction_delay_feature", "_UI_PathDelayRestriction_type"),
				 RestrictionsPackage.Literals.PATH_DELAY_RESTRICTION__DELAY,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns PathDelayRestriction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PathDelayRestriction"));
	}
	...
	public String getText(Object object) {
		String label = ((PathDelayRestriction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PathDelayRestriction_type") :
			getString("_UI_PathDelayRestriction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PathDelayRestriction.class)) {
