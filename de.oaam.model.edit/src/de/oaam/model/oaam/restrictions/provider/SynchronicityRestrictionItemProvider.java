...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.restrictions.SynchronicityRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SynchronicityRestrictionItemProvider extends OaamBaseElementAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SynchronicityRestrictionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskRestrictionA_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskRestrictionA_tasks_feature", "_UI_TaskRestrictionA_type"),
				 RestrictionsPackage.Literals.TASK_RESTRICTION_A__TASKS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMaxJitterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SynchronicityRestriction_maxJitter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SynchronicityRestriction_maxJitter_feature", "_UI_SynchronicityRestriction_type"),
				 RestrictionsPackage.Literals.SYNCHRONICITY_RESTRICTION__MAX_JITTER,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns SynchronicityRestriction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SynchronicityRestriction"));
	}
	...
	public String getText(Object object) {
		String label = ((SynchronicityRestriction)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SynchronicityRestriction.class)) {
