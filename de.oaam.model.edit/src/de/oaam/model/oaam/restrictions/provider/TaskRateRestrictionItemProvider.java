...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.restrictions.TaskRateRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskRateRestrictionItemProvider extends TaskRestrictionAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskRateRestrictionItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMaxDeviationPropertyDescriptor(object);
		}
	...
	protected void addRatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskRateRestriction_rate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskRateRestriction_rate_feature", "_UI_TaskRateRestriction_type"),
				 RestrictionsPackage.Literals.TASK_RATE_RESTRICTION__RATE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Max Deviation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMaxDeviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskRateRestriction_maxDeviation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskRateRestriction_maxDeviation_feature", "_UI_TaskRateRestriction_type"),
				 RestrictionsPackage.Literals.TASK_RATE_RESTRICTION__MAX_DEVIATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	/**
	 * This returns TaskRateRestriction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskRateRestriction"));
	}
	...
	public String getText(Object object) {
		String label = ((TaskRateRestriction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TaskRateRestriction_type") :
			getString("_UI_TaskRateRestriction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TaskRateRestriction.class)) {
