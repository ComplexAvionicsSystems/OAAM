...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.safety.taskInternalRequirements.Not} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NotItemProvider extends BooleanOperatorAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Not_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Not_expr_feature", "_UI_Not_type"),
				 TaskInternalRequirementsPackage.Literals.NOT__EXPR,
				 true,
				 false,
				 true,
				 null,
