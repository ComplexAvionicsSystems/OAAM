...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.safety.taskInternalRequirements.Or} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrItemProvider extends BooleanOperatorAItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_exprB_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_exprB_feature", "_UI_Or_type"),
				 TaskInternalRequirementsPackage.Literals.OR__EXPR_B,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addExprAPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_exprA_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_exprA_feature", "_UI_Or_type"),
				 TaskInternalRequirementsPackage.Literals.OR__EXPR_A,
				 true,
				 false,
				 true,
				 null,
