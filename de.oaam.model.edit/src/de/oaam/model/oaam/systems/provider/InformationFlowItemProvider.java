...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.systems.InformationFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InformationFlowItemProvider extends OaamBaseElementAItemProvider {
	/**
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InformationFlow_from_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InformationFlow_from_feature", "_UI_InformationFlow_type"),
				 SystemsPackage.Literals.INFORMATION_FLOW__FROM,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InformationFlow_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InformationFlow_to_feature", "_UI_InformationFlow_type"),
				 SystemsPackage.Literals.INFORMATION_FLOW__TO,
				 true,
				 false,
				 true,
				 null,
