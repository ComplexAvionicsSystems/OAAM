...
/**
 * This is the item provider adapter for a {@link de.oaam.model.oaam.systems.InformationMaterial} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InformationMaterialItemProvider extends ProvidedInformationAItemProvider {
	/**
	 ...
	 * @generated
	 */
	public InformationMaterialItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDensityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InformationMaterial_density_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InformationMaterial_density_feature", "_UI_InformationMaterial_type"),
				 SystemsPackage.Literals.INFORMATION_MATERIAL__DENSITY,
				 true,
				 false,
				 false,
	...
	protected void addVelocityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InformationMaterial_velocity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InformationMaterial_velocity_feature", "_UI_InformationMaterial_type"),
				 SystemsPackage.Literals.INFORMATION_MATERIAL__VELOCITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	/**
	 * This returns InformationMaterial.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InformationMaterial"));
	}
	...
	public String getText(Object object) {
		String label = ((InformationMaterial)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InformationMaterial.class)) {
