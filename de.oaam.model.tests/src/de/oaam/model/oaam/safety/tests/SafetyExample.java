...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>safety</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SafetyExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.safety"));
				PartFailureMode root = SafetyFactory.eINSTANCE.createPartFailureMode();
