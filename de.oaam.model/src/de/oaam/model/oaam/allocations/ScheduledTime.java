 ...
 * </p>
 * <ul>
 *   <li>{@link de.oaam.model.oaam.allocations.ScheduledTime#getCycle <em>Cycle</em>}</li>
 *   <li>{@link de.oaam.model.oaam.allocations.ScheduledTime#getStartTime <em>Start Time</em>}</li>
 *   <li>{@link de.oaam.model.oaam.allocations.ScheduledTime#getDuration <em>Duration</em>}</li>
 *   <li>{@link de.oaam.model.oaam.allocations.ScheduledTime#isRestart <em>Restart</em>}</li>
 * </ul>
 *
 * @see de.oaam.model.oaam.allocations.AllocationsPackage#getScheduledTime()
 * @model annotation="http://www.obeo.fr/dsl/dnc/archetype archetype='Role'"
 * @generated
 */
public interface ScheduledTime extends OaamBaseElementA, ModeDependentElementA, VariantDependentElementA {
	/**
	 ...
	 * @see #setCycle(int)
	 * @see de.oaam.model.oaam.allocations.AllocationsPackage#getScheduledTime_Cycle()
	...
	/**
	 * Sets the value of the '{@link de.oaam.model.oaam.allocations.ScheduledTime#getCycle <em>Cycle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.oaam.model.oaam.allocations.AllocationsPackage#getScheduledTime_StartTime()
	...
	/**
	 * Sets the value of the '{@link de.oaam.model.oaam.allocations.ScheduledTime#getStartTime <em>Start Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.oaam.model.oaam.allocations.AllocationsPackage#getScheduledTime_Duration()
	 * @model default="0.0" required="true"
	 * @generated
	 */
	double getDuration();
	...
	/**
	 * Sets the value of the '{@link de.oaam.model.oaam.allocations.ScheduledTime#getDuration <em>Duration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.oaam.model.oaam.allocations.AllocationsPackage#getScheduledTime_Restart()
	...
	/**
	 * Sets the value of the '{@link de.oaam.model.oaam.allocations.ScheduledTime#isRestart <em>Restart</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
