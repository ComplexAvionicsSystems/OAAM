 ...
 * </p>
 * <ul>
 *   <li>{@link de.oaam.model.oaam.allocations.impl.SignalAssignmentSegmentImpl#getVariants <em>Variants</em>}</li>
 *   <li>{@link de.oaam.model.oaam.allocations.impl.SignalAssignmentSegmentImpl#getOperationModes <em>Operation Modes</em>}</li>
 ...
 * @generated
 */
public class SignalAssignmentSegmentImpl extends OaamBaseElementAImpl implements SignalAssignmentSegment {
	/**
	...
	protected EClass eStaticClass() {
		return AllocationsPackage.Literals.SIGNAL_ASSIGNMENT_SEGMENT;
	}
	...
	public EList<Variant> getVariants() {
		if (variants == null) {
			variants = new EObjectResolvingEList<Variant>(Variant.class, this, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__VARIANTS);
		}
		return variants;
	}
	...
	public EList<OperationModeReference> getOperationModes() {
		if (operationModes == null) {
			operationModes = new EObjectContainmentEList<OperationModeReference>(OperationModeReference.class, this, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__OPERATION_MODES);
		}
		...
		if (capability != null && capability.eIsProxy()) {
			...
			if (capability != oldCapability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__CAPABILITY, oldCapability, capability));
			}
		}
		return capability;
	}
	...
	public void setCapability(SignalOnConnectionOrDeviceCapability newCapability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__CAPABILITY, oldCapability, capability));
	}
	...
	public Device getDevice() {
		if (device != null && device.eIsProxy()) {
			...
			if (device != oldDevice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__DEVICE, oldDevice, device));
			}
		}
		return device;
	}
	...
	public void setDevice(Device newDevice) {
		...
		device = newDevice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__DEVICE, oldDevice, device));
	}
	...
	public Connection getConnection() {
		if (connection != null && connection.eIsProxy()) {
			...
			if (connection != oldConnection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__CONNECTION, oldConnection, connection));
			}
		}
		return connection;
	}
	...
	public void setConnection(Connection newConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__CONNECTION, oldConnection, connection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__VARIANTS:
				return getVariants();
			case AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__OPERATION_MODES:
				return getOperationModes();
			case AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__CAPABILITY:
				if (resolve) return getCapability();
				return basicGetCapability();
			case AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__DEVICE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == VariantDependentElementA.class) {
			switch (derivedFeatureID) {
				case AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__VARIANTS: return ScenarioPackage.VARIANT_DEPENDENT_ELEMENT_A__VARIANTS;
				default: return -1;
			}
		}
		if (baseClass == ModeDependentElementA.class) {
			switch (derivedFeatureID) {
				case AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__OPERATION_MODES: return ScenarioPackage.MODE_DEPENDENT_ELEMENT_A__OPERATION_MODES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == VariantDependentElementA.class) {
			switch (baseFeatureID) {
				case ScenarioPackage.VARIANT_DEPENDENT_ELEMENT_A__VARIANTS: return AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__VARIANTS;
				default: return -1;
			}
		}
		if (baseClass == ModeDependentElementA.class) {
			switch (baseFeatureID) {
				case ScenarioPackage.MODE_DEPENDENT_ELEMENT_A__OPERATION_MODES: return AllocationsPackage.SIGNAL_ASSIGNMENT_SEGMENT__OPERATION_MODES;
				default: return -1;
			}
		}
