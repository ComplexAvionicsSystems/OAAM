...
public class FunctionsPackageImpl extends EPackageImpl implements FunctionsPackage {
	...
	public void initializePackageContents() {
		...
		functionsContainerAEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		functionsContainerAEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		functionsContainerAEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskLinkEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskLinkEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskLinkEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskGroupEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskGroupEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskGroupEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskSymmetryEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskSymmetryEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskSymmetryEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskRedundancyEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskRedundancyEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskRedundancyEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		failureConditionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		failureConditionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		failureConditionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		systemInputStateEClass.getESuperTypes().add(theCommonPackage.getBoolA());
		systemInputStateEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		systemInputStateEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		systemInputStateEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		signalEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		signalEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		signalEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		signalGroupEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		signalGroupEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		signalGroupEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		inputEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		inputEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		inputEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		outputEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		outputEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		outputEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		outputLinkEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		outputLinkEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		outputLinkEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		...
		initEAttribute(getOutput_FixedRate(), ecorePackage.getEFloat(), "fixedRate", null, 1, 1, Output.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
