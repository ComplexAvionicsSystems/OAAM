...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @generated
	 */
	public EAttribute getOutputTrigger_IdFixedRate() {
	...
	public void createPackageContents() {
		...
		createEAttribute(outputTriggerEClass, OUTPUT_TRIGGER__ID_FIXED_RATE);
	...
	public void initializePackageContents() {
		...
		libraryContainerAEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceTypeEClass.getESuperTypes().add(this.getResourceConsumerA());
		resourceTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceAlternativesEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceBundlesEClass.getESuperTypes().add(this.getResourceConsumerA());
		resourceBundlesEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskTypeEClass.getESuperTypes().add(this.getResourceConsumerA());
		taskTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		signalTypeEClass.getESuperTypes().add(this.getResourceConsumerA());
		signalTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		...
		deviceTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		...
		connectionTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		locationTypeEClass.getESuperTypes().add(this.getResourceProviderA());
		locationTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		ductTypeEClass.getESuperTypes().add(this.getResourceProviderA());
		ductTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		wireTypeEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		inputDeclarationEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		outputDeclarationEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		ioDeclarationEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		ductOpeningDeclarationEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceGroupEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		deviceTypeSymmetryEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		ioGroupEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		attributeDefinitionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		faultPropagationEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		functionInputStateEClass.getESuperTypes().add(theCommonPackage.getBoolA());
		functionInputStateEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		powerSourceEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceLinkEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceModifierEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		modifierLevelEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		modifierLevelEClass.getESuperTypes().add(this.getResourceConsumerA());
		modifierDefinitionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskTypeDissimilarityEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		deviceTypeDissimilarityEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		resourceTypeDissimilarityEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		libraryEClass.getESuperTypes().add(this.getLibraryContainerA());
		sublibraryEClass.getESuperTypes().add(this.getLibraryContainerA());
		outputTriggerEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		functionInputTriggerEClass.getESuperTypes().add(theCommonPackage.getBoolA());
		functionInputTriggerEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		...
		initEAttribute(getOutputTrigger_IdFixedRate(), ecorePackage.getEBoolean(), "idFixedRate", null, 1, 1, OutputTrigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
