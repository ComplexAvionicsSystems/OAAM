...
public class DeviceRestrictionImpl extends TaskRestrictionAImpl implements DeviceRestriction {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == _ElementA.class) {
			switch (derivedFeatureID) {
				case RestrictionsPackage.DEVICE_RESTRICTION__ID: return CommonPackage._ELEMENT_A__ID;
				case RestrictionsPackage.DEVICE_RESTRICTION__NAME: return CommonPackage._ELEMENT_A__NAME;
				case RestrictionsPackage.DEVICE_RESTRICTION__STYLE: return CommonPackage._ELEMENT_A__STYLE;
				case RestrictionsPackage.DEVICE_RESTRICTION__ATTRIBUTES: return CommonPackage._ELEMENT_A__ATTRIBUTES;
				case RestrictionsPackage.DEVICE_RESTRICTION__DOCUMENTATION: return CommonPackage._ELEMENT_A__DOCUMENTATION;
				case RestrictionsPackage.DEVICE_RESTRICTION__MODIFIED: return CommonPackage._ELEMENT_A__MODIFIED;
				case RestrictionsPackage.DEVICE_RESTRICTION__MODIFIER: return CommonPackage._ELEMENT_A__MODIFIER;
				case RestrictionsPackage.DEVICE_RESTRICTION__TRACE_LINK: return CommonPackage._ELEMENT_A__TRACE_LINK;
				default: return -1;
			}
		}
		if (baseClass == _VariantDependentElementA.class) {
			switch (derivedFeatureID) {
				case RestrictionsPackage.DEVICE_RESTRICTION__VARIANTS: return ScenarioPackage._VARIANT_DEPENDENT_ELEMENT_A__VARIANTS;
				default: return -1;
			}
		}
		if (baseClass == _ModeDependentElementA.class) {
			switch (derivedFeatureID) {
				case RestrictionsPackage.DEVICE_RESTRICTION__OPERATION_MODES: return ScenarioPackage._MODE_DEPENDENT_ELEMENT_A__OPERATION_MODES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == _ElementA.class) {
			switch (baseFeatureID) {
				case CommonPackage._ELEMENT_A__ID: return RestrictionsPackage.DEVICE_RESTRICTION__ID;
				case CommonPackage._ELEMENT_A__NAME: return RestrictionsPackage.DEVICE_RESTRICTION__NAME;
				case CommonPackage._ELEMENT_A__STYLE: return RestrictionsPackage.DEVICE_RESTRICTION__STYLE;
				case CommonPackage._ELEMENT_A__ATTRIBUTES: return RestrictionsPackage.DEVICE_RESTRICTION__ATTRIBUTES;
				case CommonPackage._ELEMENT_A__DOCUMENTATION: return RestrictionsPackage.DEVICE_RESTRICTION__DOCUMENTATION;
				case CommonPackage._ELEMENT_A__MODIFIED: return RestrictionsPackage.DEVICE_RESTRICTION__MODIFIED;
				case CommonPackage._ELEMENT_A__MODIFIER: return RestrictionsPackage.DEVICE_RESTRICTION__MODIFIER;
				case CommonPackage._ELEMENT_A__TRACE_LINK: return RestrictionsPackage.DEVICE_RESTRICTION__TRACE_LINK;
				default: return -1;
			}
		}
		if (baseClass == _VariantDependentElementA.class) {
			switch (baseFeatureID) {
				case ScenarioPackage._VARIANT_DEPENDENT_ELEMENT_A__VARIANTS: return RestrictionsPackage.DEVICE_RESTRICTION__VARIANTS;
				default: return -1;
			}
		}
		if (baseClass == _ModeDependentElementA.class) {
			switch (baseFeatureID) {
				case ScenarioPackage._MODE_DEPENDENT_ELEMENT_A__OPERATION_MODES: return RestrictionsPackage.DEVICE_RESTRICTION__OPERATION_MODES;
				default: return -1;
			}
		}
