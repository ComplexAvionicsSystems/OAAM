 ...
 *   <li>{@link de.oaam.model.oaam.restrictions.impl.DeviceTypeRestrictionImpl#getSubFunctions <em>Sub Functions</em>}</li>
...
public class DeviceTypeRestrictionImpl extends TaskRestrictionAImpl implements DeviceTypeRestriction {
	...
	public EList<Subfunction> getSubFunctions() {
		if (subFunctions == null) {
			subFunctions = new EObjectResolvingEList<Subfunction>(Subfunction.class, this, RestrictionsPackage.DEVICE_TYPE_RESTRICTION__SUB_FUNCTIONS);
		}
		return subFunctions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestrictionsPackage.DEVICE_TYPE_RESTRICTION__SIGNALS:
				return getSignals();
			case RestrictionsPackage.DEVICE_TYPE_RESTRICTION__SUB_FUNCTIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SubFunctionRestrictionA.class) {
			switch (derivedFeatureID) {
				case RestrictionsPackage.DEVICE_TYPE_RESTRICTION__SUB_FUNCTIONS: return RestrictionsPackage.SUB_FUNCTION_RESTRICTION_A__SUB_FUNCTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SubFunctionRestrictionA.class) {
			switch (baseFeatureID) {
				case RestrictionsPackage.SUB_FUNCTION_RESTRICTION_A__SUB_FUNCTIONS: return RestrictionsPackage.DEVICE_TYPE_RESTRICTION__SUB_FUNCTIONS;
				default: return -1;
			}
		}
		if (baseClass == ElementA.class) {
