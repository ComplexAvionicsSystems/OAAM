...
public class RestrictionsPackageImpl extends EPackageImpl implements RestrictionsPackage {
	...
	public void initializePackageContents() {
		...
		restrictionsContainerAEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		...
		subrestrictionsEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		subrestrictionsEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		pathSegmentEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		...
		locationRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		locationRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		locationRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		...
		areaRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		areaRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		areaRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		...
		powerSourceRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		powerSourceRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		powerSourceRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		...
		deviceRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		deviceRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		deviceRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		...
		deviceTypeRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		deviceTypeRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		deviceTypeRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		...
		conectionTypeRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		conectionTypeRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		conectionTypeRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		...
		connectionRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		connectionRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		connectionRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		segregationRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		segregationRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		segregationRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskRateRestrictionEClass.getESuperTypes().add(this.getTaskRestrictionA());
		taskRateRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskRateRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskRateRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		inputSynchronicityRestrictionEClass.getESuperTypes().add(this.getInputRestrictionA());
		inputSynchronicityRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		inputSynchronicityRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		inputSynchronicityRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		pathDelayRestrictionEClass.getESuperTypes().add(this.getPathRestrictionA());
		pathDelayRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		pathDelayRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		pathDelayRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskAtomicRestrictionEClass.getESuperTypes().add(this.getTaskRestrictionA());
		taskAtomicRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskAtomicRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskAtomicRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
		taskSymmetryRestrictionEClass.getESuperTypes().add(this.getTaskRestrictionA());
		taskSymmetryRestrictionEClass.getESuperTypes().add(theCommonPackage.get_ElementA());
		taskSymmetryRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_ModeDependentElementA());
		taskSymmetryRestrictionEClass.getESuperTypes().add(theScenarioPackage.get_VariantDependentElementA());
