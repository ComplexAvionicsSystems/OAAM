	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementA.class) {
			switch (derivedFeatureID) {
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__ID: return CommonPackage.ELEMENT_A__ID;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__NAME: return CommonPackage.ELEMENT_A__NAME;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__STYLE: return CommonPackage.ELEMENT_A__STYLE;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__ATTRIBUTES: return CommonPackage.ELEMENT_A__ATTRIBUTES;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__DOCUMENTATION: return CommonPackage.ELEMENT_A__DOCUMENTATION;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__MODIFIED: return CommonPackage.ELEMENT_A__MODIFIED;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__MODIFIER: return CommonPackage.ELEMENT_A__MODIFIER;
				case RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__TRACE_LINK: return CommonPackage.ELEMENT_A__TRACE_LINK;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementA.class) {
			switch (baseFeatureID) {
				case CommonPackage.ELEMENT_A__ID: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__ID;
				case CommonPackage.ELEMENT_A__NAME: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__NAME;
				case CommonPackage.ELEMENT_A__STYLE: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__STYLE;
				case CommonPackage.ELEMENT_A__ATTRIBUTES: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__ATTRIBUTES;
				case CommonPackage.ELEMENT_A__DOCUMENTATION: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__DOCUMENTATION;
				case CommonPackage.ELEMENT_A__MODIFIED: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__MODIFIED;
				case CommonPackage.ELEMENT_A__MODIFIER: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__MODIFIER;
				case CommonPackage.ELEMENT_A__TRACE_LINK: return RestrictionsPackage.TASK_SYMMETRY_RESTRICTION__TRACE_LINK;
				default: return -1;
			}
		}
		if (baseClass == ModeDependentElementA.class) {
