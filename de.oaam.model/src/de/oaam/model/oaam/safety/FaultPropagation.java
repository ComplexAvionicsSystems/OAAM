 ...
 * </p>
 * <ul>
 *   <li>{@link de.oaam.model.oaam.safety.FaultPropagation#getOutputState <em>Output State</em>}</li>
 *   <li>{@link de.oaam.model.oaam.safety.FaultPropagation#getCondition <em>Condition</em>}</li>
 *   <li>{@link de.oaam.model.oaam.safety.FaultPropagation#getBooleanOperations <em>Boolean Operations</em>}</li>
 *   <li>{@link de.oaam.model.oaam.safety.FaultPropagation#getBooleanNots <em>Boolean Nots</em>}</li>
 *   <li>{@link de.oaam.model.oaam.safety.FaultPropagation#getTaskInputStates <em>Task Input States</em>}</li>
 * </ul>
 *
 * @see de.oaam.model.oaam.safety.SafetyPackage#getFaultPropagation()
 * @model
 * @generated
 */
public interface FaultPropagation extends OaamBaseElementA {
	 ...
	 * @see #setOutputState(IntegrityStateE)
	 * @see de.oaam.model.oaam.safety.SafetyPackage#getFaultPropagation_OutputState()
	 * @model required="true"
	 * @generated
	 */
	IntegrityStateE getOutputState();

	/**
	 * Sets the value of the '{@link de.oaam.model.oaam.safety.FaultPropagation#getOutputState <em>Output State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setOutputState(IntegrityStateE value);
	 ...
	 * @see de.oaam.model.oaam.safety.SafetyPackage#getFaultPropagation_Condition()
	 * @model required="true"
	 * @generated
	 */
	BoolA getCondition();
	...
	/**
	 * Sets the value of the '{@link de.oaam.model.oaam.safety.FaultPropagation#getCondition <em>Condition</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.oaam.model.oaam.safety.SafetyPackage#getFaultPropagation_BooleanOperations()
	 ...
	 * @see de.oaam.model.oaam.safety.SafetyPackage#getFaultPropagation_BooleanNots()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see de.oaam.model.oaam.safety.SafetyPackage#getFaultPropagation_TaskInputStates()
	 * @model containment="true"
	 * @generated
	 */
