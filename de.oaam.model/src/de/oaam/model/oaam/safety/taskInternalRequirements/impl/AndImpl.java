 ...
 * </p>
 * <ul>
 *   <li>{@link de.oaam.model.oaam.safety.taskInternalRequirements.impl.AndImpl#getExprB <em>Expr B</em>}</li>
 *   <li>{@link de.oaam.model.oaam.safety.taskInternalRequirements.impl.AndImpl#getExprA <em>Expr A</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndImpl extends BooleanOperatorAImpl implements And {
	/**
	...
	protected EClass eStaticClass() {
		return TaskInternalRequirementsPackage.Literals.AND;
	}
		...
		if (exprB != null && exprB.eIsProxy()) {
			...
			if (exprB != oldExprB) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaskInternalRequirementsPackage.AND__EXPR_B, oldExprB, exprB));
			}
		}
		return exprB;
	}
	...
	public void setExprB(RequirementComponentA newExprB) {
		...
		exprB = newExprB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskInternalRequirementsPackage.AND__EXPR_B, oldExprB, exprB));
	}
	...
	public RequirementComponentA getExprA() {
		if (exprA != null && exprA.eIsProxy()) {
			...
			if (exprA != oldExprA) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TaskInternalRequirementsPackage.AND__EXPR_A, oldExprA, exprA));
			}
		}
		return exprA;
	}
	...
	public void setExprA(RequirementComponentA newExprA) {
		...
		exprA = newExprA;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TaskInternalRequirementsPackage.AND__EXPR_A, oldExprA, exprA));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TaskInternalRequirementsPackage.AND__EXPR_B:
				if (resolve) return getExprB();
				return basicGetExprB();
			case TaskInternalRequirementsPackage.AND__EXPR_A:
