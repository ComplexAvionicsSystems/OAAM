 ...
 * </p>
 * <ul>
 *   <li>{@link de.oaam.model.oaam.scenario.impl.ParameterAImpl#getVariants <em>Variants</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ParameterAImpl extends _ModeDependentElementAImpl implements ParameterA {
	...
	protected EClass eStaticClass() {
		return ScenarioPackage.Literals.PARAMETER_A;
	}
	...
	public EList<Variant> getVariants() {
		if (variants == null) {
			variants = new EObjectResolvingEList<Variant>(Variant.class, this, ScenarioPackage.PARAMETER_A__VARIANTS);
		}
		return variants;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScenarioPackage.PARAMETER_A__VARIANTS:
				return getVariants();
		}
